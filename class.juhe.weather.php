...
class weather{  
    ...
    private $cityUrl = 'http://v.juhe.cn/weather/citys'; 
  
    private $weatherUrl = 'http://v.juhe.cn/weather/index'; 
  
    private $weatherIPUrl = 'http://v.juhe.cn/weather/ip'; 
  
    private $weatherGeoUrl = 'http://v.juhe.cn/weather/geo';
  
    private $forecast3hUrl = 'http://v.juhe.cn/weather/forecast3h';
